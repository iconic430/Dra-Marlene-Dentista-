      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-gold-200 rounded-2xl transform rotate-3 transition-transform duration-500 hover:rotate-6"></div>
            <img 
          ...
          <div className="space-y-8">
            ...
            <div className="pt-4">
                <a href="#contacto" className="inline-flex items-center gap-2 text-lilac-700 font-bold hover:text-lilac-900 border-b-2 border-gold-400 pb-1 transition-colors">
                  <Smile size={20} />
