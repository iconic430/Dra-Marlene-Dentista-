        ...
        <div className="mt-16 text-center">
            <div className="inline-block bg-white p-6 rounded-xl shadow-md border-l-4 border-gold-500">
                <p className="text-lg text-gray-700">
                    ...
                    <a href="https://wa.link/ktc9e6" target="_blank" rel="noopener noreferrer" className="text-lilac-700 font-bold hover:underline">Agenda una valoración</a> y diseñaremos un plan a tu medida.
                </p>
            </div>
        </div>
      </div>
